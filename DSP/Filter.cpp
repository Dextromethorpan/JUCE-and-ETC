...
{
    //BandPass
    bandpassFilterCoefficients = juce::dsp::IIR::Coefficients<float>::makeLowPass(inSpec.sampleRate, 100.0f);
    ...
    *highpassFilter.state = juce::dsp::IIR::ArrayCoefficients<float>::makeHighPass(inSpec.sampleRate, 100.0f);
